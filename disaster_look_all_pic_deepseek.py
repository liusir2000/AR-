...
def deepseek_look(road):
    ...
    conversation = [
        {
            "role": "用户",
            "content": "<image_placeholder>这是什么气象灾害？从洪水、冰雹、大雾、大风、泥石流、大雪、闪电、龙卷、内涝中选择一个最符合的答案。",
            "images": [road]  # 图像文件路径
        },
        {
            "role": "助手",
...
result_file = open('/user_homes/chuhai/ldw2/hwx/disaster/result/deepseek_vl.txt', 'w', encoding='utf-8')
# 写入文件头（可选）
